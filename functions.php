...
function seo_rank_breadcrumbs_styles () {
...
if ( ! function_exists( 'seo_rank_breadcrumbs' ) ) {
  ...
  function seo_rank_breadcrumbs()
 {

$start_time = microtime(true);

 echo "\n" . '<!-- This breadcrumbs Generated by [ SEO Rank Breadcrumbs ] Plugin. -->';

echo seo_rank_breadcrumbs_styles();
...
echo '<div class="'.$breadcrumbs_class.'">
  <ul  id="'.$breadcrumbs_id.'"  itemscope="" itemtype="http://schema.org/BreadcrumbList" typeof="BreadcrumbList">'."\n";
...
echo "\n\n".'<script type="text/javascript">'."\n".'function seo_rank_breadcrumbs(){var elem=document.getElementsByClassName("crumb");elem[elem.length-1].setAttribute("class","current");};seo_rank_breadcrumbs();'."\n".'</script>'."\n\n";

echo "\n"."<!-- This breadcrumbs generated by [ SEO Rank Breadcrumbs ] plugin, with in ".round($end_time-$start_time, 3). " milliseconds. -->"."\n";
  }
}
